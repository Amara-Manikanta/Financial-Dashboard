...
const Taxes = () => {
    ...
    const [activeTab, setActiveTab] = useState('itr'); // 'itr', 'partA', 'partB'
        ...
        <div style={{ padding: '2rem', maxWidth: '1200px', margin: '0 auto' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
                <div>
                    ...
                    <p style={{ color: '#a1a1aa', marginTop: '0.5rem' }}>Track your Form 16s and ITR Filings</p>
                </div>
                <button
            ...
            {/* Aggregates (Only show on ITR Tab) */}
